...
#LOAD_FROM = "F:\\programing\\python\\machine_learning_hub\\_not code_\\DECORDERS\\enc-dec_17\\saves_4\\"
LOAD_FROM = None
enc = None
dec = None
if(LOAD_FROM == None):
    enc = get_encoder_218X178(40)
    dec = get_decoder_218X178(100,40)
else:
...
for i in range(buffers):
    ...
    d2.train(batch,batch_size=32,callback=callback)
